...
activities or enhancing human activities \citep{Royal-narratives18}.
...
dynamics \citep{Paleyes-challenges22}.
...
consistent, despite changes or transformations in a system \citep{Villar-scalars21}.
...
candidate drugs \citep{Klami-virtual22}.
...
combine both human and machine intelligence \citep{Celikok-best22}.
...
stars \citep{NASA-gravitational}.
...
instruments that measure them \citep{Dax-gravitational21}.
...
learning more efficient \citep{Dax-gravitational21}. An alternative, however, is to
use deterministic models that already reflect relevant physical
laws \citep{Bodin-black21}. Across these approaches,
...
into AI systems \citep{Villar-dimensionless22}.
...
\item
  ...
  models with unknown forces \citep{Ward-blackbox20}.
\item
  ...
  representations, or invoking symmetries as constraints.\footnote{See,
    for example: \citep{Kondor-generalization18,Maron-invariant18,Dym-universality20}}
\item
...
\item
  Interactive knowledge elicitation \citep{Sundin-improving18},
  combining prior knowledge from cognitive science with learning from
  data \citep{Kangasraasio-parameter19},
  and generative user models \citep{DePeuter-toward21}
