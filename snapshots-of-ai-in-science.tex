...
laws of physics \citep{Requena-predicting19}.
...
simulation.\footnote{Examples of agent-based models for crowd simulation
  include: \citep{Makinoshima-crowd22,Malleson-simulating20}} In these systems the initial system state is
...
growth \citep{}.\footnote{Krishnamurthy, K.V., Bahadur, B., John Adams, S.,
